...
public class GameManager : MonoBehaviour
{
    ...
    {
        h2Score.text = "10×"+h2.ToString();
        yield return new WaitForSeconds(0.5f);
        o2Score.text = "10×" + o2.ToString();
        yield return new WaitForSeconds(0.5f);
        n2Score.text = "10×" + n2.ToString();
        yield return new WaitForSeconds(0.5f);
        h2oScore.text = "50×" + h2o.ToString();
        yield return new WaitForSeconds(0.5f);
        nh3Score.text = "150×" + nh3.ToString();
        yield return new WaitForSeconds(0.5f);
        h2so4Score.text = "500×" + h2so4.ToString();
        yield return new WaitForSeconds(0.5f);
